	...
	methods: {
		fetchProfile: function () {
			this.user.profile = {
				...
				email: dummyUser.profile.email,
				image: dummyUser.profile.image,
				commentsLength: dummyUser.profile.Comments.length,
				favoritedCounts: dummyUser.profile.FavoritedRestaurants.length,
				followingsCounts: dummyUser.profile.Followings.length,
				followersCounts: dummyUser.profile.Followers.length,
			}
			this.user.followings = dummyUser.profile.Followings
			this.user.followers = dummyUser.profile.Followers
			this.user.comments = dummyUser.profile.Comments
			this.user.favoritedRestaurants = dummyUser.profile.FavoritedRestaurants
		},
	},
	created() {
